...
#ifndef __gwas_winners_curse_FILEINTERFACE_FILEINTERFACE_READER_H__
#define __gwas_winners_curse_FILEINTERFACE_FILEINTERFACE_READER_H__
...
#endif //__gwas_winners_curse_FILEINTERFACE_FILEINTERFACE_READER_H__
