...
#ifndef __gwas_winners_curse_FILEINTERFACE_FILEINTERFACE_WRITER_H__
#define __gwas_winners_curse_FILEINTERFACE_FILEINTERFACE_WRITER_H__
...
#endif //__gwas_winners_curse_FILEINTERFACE_FILEINTERFACE_WRITER_H__
